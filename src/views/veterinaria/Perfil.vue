<template>
	<div class="fade-in">
		<div class="d-flex justify-content-between align-items-center mb-4">
			<h2><i class="bi bi-hospital me-2"></i>Mi Perfil</h2>
			<router-link :to="{ name: 'VeterinariaEditarPerfil' }" class="btn btn-primary">
			...
			<div class="card-body p-4">
				<div class="row">
					<div class="col-md-3 text-center">
						<div class="avatar-lg bg-success mx-auto mb-3" style="width:120px;height:120px;font-size:3rem;">{{ iniciales }}</div>
					</div>
					<div class="col-md-9">
						<h3>{{ veterinaria.nombreClinica }}</h3>
						<p class="text-muted mb-3">{{ veterinaria.especialidad }}</p>
						<div class="row">
							<div class="col-md-6 mb-3"><strong>Responsable:</strong><p>{{ nombreCompleto(veterinaria.usuario) }}</p></div>
							<div class="col-md-6 mb-3"><strong>Teléfono:</strong><p>{{ veterinaria.telefono }}</p></div>
							<div class="col-12 mb-3"><strong>Dirección:</strong><p>{{ veterinaria.direccion }}</p></div>
						</div>
					</div>
				</div>
			</div>
